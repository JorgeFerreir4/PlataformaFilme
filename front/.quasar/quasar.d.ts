...
interface ImportMetaEnv {
  ...
  readonly GNOME_KEYRING_CONTROL?: string;
  readonly NVM_DIR?: string;
  readonly DEBUGINFOD_URLS?: string;
  readonly QT_QPA_PLATFORMTHEME?: string;
  ...
  readonly CLUTTER_BACKEND?: string;
  readonly TERM?: string;
  readonly GTK_OVERLAY_SCROLLING?: number;
  readonly XDG_SESSION_ID?: string;
  ...
  readonly SBX_CHROME_API_RQ?: number;
  ...
  readonly QT_ACCESSIBILITY?: number;
  readonly GDMSESSION?: string;
  readonly LESSCLOSE?: string;
  ...
  readonly CLUTTER_IM_MODULE?: string;
